...
GO
PRINT N'Starting rebuilding table [dbo].[HondaWMI]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_HondaWMI] (
    [Id]                    INT            NOT NULL,
    ...
    CONSTRAINT [tmp_ms_xx_constraint_PK_HondaWMI1] PRIMARY KEY CLUSTERED ([WMI] ASC)
);

IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[HondaWMI])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_HondaWMI] ([WMI], [Id], [Name], [VehicleType], [Country], [DateAvailableToPublic], [CreatedOn], [UpdatedOn])
        SELECT   [WMI],
                 [Id],
                 [Name],
                 [VehicleType],
...
DROP TABLE [dbo].[HondaWMI];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_HondaWMI]', N'HondaWMI';

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_constraint_PK_HondaWMI1]', N'PK_HondaWMI', N'OBJECT';
